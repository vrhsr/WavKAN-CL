...
# --- CONFIGURATION (NUCLEAR OPTION 2.0) ---
SEEDS = [
...
PATIENCE = 20        # INCREASED from 10 (Early Stopping)
SCHEDULER_PATIENCE = 10 # INCREASED from 7
MIXUP_ALPHA = 0.2
...
def train_model(model_name, seed):
    set_seed(seed)
    print(f"\n🏃 TRAINING {model_name.upper()} | SEED {seed} | 100 EPOCHS")
    ...
    scheduler = optim.lr_scheduler.ReduceLROnPlateau(optimizer, mode='max', factor=0.5, patience=SCHEDULER_PATIENCE) # 10
...
if __name__ == "__main__":
    print("="*60)
    print(f"☢️ NUCLEAR OPTION 2.0: 100 EPOCHS x 20 SEEDS ☢️")
    print("="*60)
    ...
    print("\n" + "="*60)
    print(f"✅ FINAL RUN COMPLETE. Total Time: {total_time:.2f} hours")
    print("Run 'python src/eval_final_100.py' for comparison.")
    print("="*60)
